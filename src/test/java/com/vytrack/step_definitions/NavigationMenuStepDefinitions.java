...
public class NavigationMenuStepDefinitions {
    ...
    public void the_user_goes_to_Fleet_Vehicles() {
        System.out.println("Opening Fleet, Vehicle");
    }
    ...
    public void the_url_should_be_https_qa_vytrack_com_entity_Extend_Entity_Carreservation(Integer int1) {
        System.out.println("Varifying url for vehicles");
    }
    ...
    @Then("the url should be https:\\/\\/qa{int}.vytrack.com\\/calendar\\/events")
    public void the_url_should_be_https_qa_vytrack_com_calendar_events(Integer int1) {
